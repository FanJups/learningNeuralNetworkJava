...
/**
 *
 * Linear This class represents the pure linear activation function,
...
public class Linear implements IActivationFunction {
	...
	/**
	 * setA Sets a new coefficient for the Linear function
	 * 
	...
	/**
	 * calc Performs the calculation of this function
	 * 
	 * @param x
