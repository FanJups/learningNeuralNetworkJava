...
/**
 *
 * HyperTan This class represents the Hyperbolic Tangent Activation Function
 * implementing the interface IActivationFunction
 * 
...
public class HyperTan implements IActivationFunction {
	...
	/**
	 * setA Sets a new coefficient for this function
	 * 
	 * @param value new coefficient
	 */
	...
	/**
	 * calc Peforms the calculation of hyperbolic tangent of x
	 * 
	 * @param x
